...
_CHARGEUSERRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='state', full_name='billing.ChargeUserResponse.state', index=4,
...
_CHARGEUSERRESPONSE.fields_by_name['state'].enum_type = _CHARGESTATE
...
_CHARGEUSERRESPONSE.oneofs_by_name['data'].fields.append(
  _CHARGEUSERRESPONSE.fields_by_name['state'])
