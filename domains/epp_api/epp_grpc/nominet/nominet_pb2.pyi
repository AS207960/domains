...
class ReleaseRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal[u"object",b"object",u"registrar_tag",b"registrar_tag",u"registry_name",b"registry_name"]) -> None: ...
...
class Object(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal[u"domain",b"domain",u"object",b"object",u"registrant",b"registrant"]) -> None: ...
...
class DomainRegistrarChange(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        ...
        domains : typing.Optional[typing.Iterable[domain.domain_pb2.DomainInfoReply]] = ...,
        contact : typing.Optional[contact.contact_pb2.ContactInfoReply] = ...,
        ) -> None: ...
...
class ContactValidateRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal[u"contact_id",b"contact_id",u"registry_name",b"registry_name"]) -> None: ...
...
class LockRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal[u"object",b"object"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal[u"lock_type",b"lock_type",u"object",b"object",u"registry_name",b"registry_name"]) -> None: ...
