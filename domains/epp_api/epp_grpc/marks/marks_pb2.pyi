...
class Mark(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["court", b"court", "mark", b"mark", "trademark", b"trademark", "treaty_or_statute", b"treaty_or_statute"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["court", b"court", "mark", b"mark", "trademark", b"trademark", "treaty_or_statute", b"treaty_or_statute"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["mark", b"mark"]) -> typing_extensions.Literal["trademark", "treaty_or_statute", "court"] | None: ...
...
class TradeMark(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["application_date", b"application_date", "application_id", b"application_id", "expiry_date", b"expiry_date", "registration_date", b"registration_date"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["application_date", b"application_date", "application_id", b"application_id", "classes", b"classes", "contacts", b"contacts", "expiry_date", b"expiry_date", "goods_and_services", b"goods_and_services", "holders", b"holders", "id", b"id", "jurisdiction", b"jurisdiction", "labels", b"labels", "mark_name", b"mark_name", "registration_date", b"registration_date", "registration_id", b"registration_id"]) -> None: ...
...
class TreatyOrStatute(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["execution_date", b"execution_date", "protection_date", b"protection_date"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["contacts", b"contacts", "execution_date", b"execution_date", "goods_and_services", b"goods_and_services", "holders", b"holders", "id", b"id", "labels", b"labels", "mark_name", b"mark_name", "protection_date", b"protection_date", "protections", b"protections", "reference_number", b"reference_number", "title", b"title"]) -> None: ...
...
class Protection(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["country_code", b"country_code", "region", b"region", "ruling", b"ruling"]) -> None: ...
...
class Court(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["protection_date", b"protection_date"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["contacts", b"contacts", "country_code", b"country_code", "court_name", b"court_name", "goods_and_services", b"goods_and_services", "holders", b"holders", "id", b"id", "labels", b"labels", "mark_name", b"mark_name", "protection_date", b"protection_date", "reference_number", b"reference_number", "regions", b"regions"]) -> None: ...
...
class Holder(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["address", b"address", "email", b"email", "fax", b"fax", "name", b"name", "organisation", b"organisation", "voice", b"voice"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["address", b"address", "email", b"email", "entitlement", b"entitlement", "fax", b"fax", "name", b"name", "organisation", b"organisation", "voice", b"voice"]) -> None: ...
...
class Contact(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["address", b"address", "fax", b"fax", "organisation", b"organisation", "voice", b"voice"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["address", b"address", "contact_type", b"contact_type", "email", b"email", "fax", b"fax", "name", b"name", "organisation", b"organisation", "voice", b"voice"]) -> None: ...
...
class Address(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["postal_code", b"postal_code", "province", b"province", "street1", b"street1", "street2", b"street2", "street3", b"street3"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["city", b"city", "country_code", b"country_code", "postal_code", b"postal_code", "province", b"province", "street1", b"street1", "street2", b"street2", "street3", b"street3"]) -> None: ...
