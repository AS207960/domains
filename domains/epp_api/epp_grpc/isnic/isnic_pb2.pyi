...
class PaymentInfo(google.protobuf.message.Message):
    ...
    class Card(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing_extensions.Literal["cvc", b"cvc", "id", b"id"]) -> None: ...
    ...
    def HasField(self, field_name: typing_extensions.Literal["card", b"card", "payment_method", b"payment_method", "prepaid", b"prepaid"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["card", b"card", "payment_method", b"payment_method", "prepaid", b"prepaid"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["payment_method", b"payment_method"]) -> typing_extensions.Literal["prepaid", "card"] | None: ...
...
class DomainInfo(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["zone_contact", b"zone_contact"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["zone_contact", b"zone_contact"]) -> None: ...
...
class DomainUpdate(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["new_master_ns", b"new_master_ns", "remove_all_ns", b"remove_all_ns"]) -> None: ...
...
class ContactInfo(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["mobile", b"mobile", "sid", b"sid"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["auto_update_from_national_registry", b"auto_update_from_national_registry", "mobile", b"mobile", "paper_invoices", b"paper_invoices", "sid", b"sid", "statuses", b"statuses"]) -> None: ...
...
class ContactCreate(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["lang", b"lang", "mobile", b"mobile", "sid", b"sid"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["auto_update_from_national_registry", b"auto_update_from_national_registry", "lang", b"lang", "mobile", b"mobile", "paper_invoices", b"paper_invoices", "sid", b"sid"]) -> None: ...
...
class ContactUpdate(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["auto_update_from_national_registry", b"auto_update_from_national_registry", "lang", b"lang", "mobile", b"mobile", "paper_invoices", b"paper_invoices"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["auto_update_from_national_registry", b"auto_update_from_national_registry", "lang", b"lang", "mobile", b"mobile", "paper_invoices", b"paper_invoices", "password", b"password"]) -> None: ...
