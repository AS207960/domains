...
class ContactCreateReply(google___protobuf___message___Message):
    ...
    def ClearField(self, field_name: typing_extensions___Literal[u"creation_date",b"creation_date",u"id",b"id",u"pending",b"pending",u"transaction_id",b"transaction_id"]) -> None: ...
...
class ContactTransferReply(google___protobuf___message___Message):
    ...
    def ClearField(self, field_name: typing_extensions___Literal[u"act_client_id",b"act_client_id",u"act_date",b"act_date",u"pending",b"pending",u"requested_client_id",b"requested_client_id",u"requested_date",b"requested_date",u"status",b"status",u"transaction_id",b"transaction_id"]) -> None: ...
