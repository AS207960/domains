...
python3 -m grpc_tools.protoc --python_out=domains/epp_api/epp_grpc/ --grpc_python_out=domains/epp_api/epp_grpc/ --mypy_out=domains/epp_api/epp_grpc/ -I ../epp-proxy/proto/  ../epp-proxy/proto/**/*.proto ../epp-proxy/proto/*.proto
